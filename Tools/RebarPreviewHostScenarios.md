...
| SLAB_UNSUPPORTED_HOST_GEOMETRY | HOST_REQUIRED | On disposable sloped, stepped/multi-face, tapered-thickness, layered/finish, or curved-boundary floors, attempt Solve/Create; verify profile analysis rejects it before any Rebar is committed. Also verify horizontal constant-thickness straight-edged structural-core slabs use the actual face loops, not void bounding boxes. | REGISTERED_NOT_EXECUTED |
