...
| SLAB_UNSUPPORTED_HOST_GEOMETRY | HOST_REQUIRED | On a disposable sloped floor or floor with curved outer/void boundary, attempt Solve/Create; verify profile analysis rejects it before any Rebar is committed. Also verify horizontal straight-edged polygon slabs use the actual face loops, not void bounding boxes. | REGISTERED_NOT_EXECUTED |
