...
namespace KhimTools.DimensionTools.Forms
{
    ...
    {
        private readonly Document _doc; private readonly RevitView _view; private readonly IList<ElementId> _selection; private readonly ComboBox _operation = new ComboBox(); private readonly ComboBox _axis = new ComboBox(); private readonly ComboBox _strategy = new ComboBox(); private readonly NumericUpDown _offset = new NumericUpDown(); private readonly Label _status = new Label(); private Button _apply; public DimensionPlan Plan { get; private set; }
