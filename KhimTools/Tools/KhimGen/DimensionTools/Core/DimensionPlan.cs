...
namespace KhimTools.DimensionTools.Core
{
    public sealed class DimensionPlan
    {
        ...
        public DimensionPlan() { References = new List<DimensionReferenceInfo>(); Items = new List<DimensionPlanItem>(); Warnings = new List<string>(); Errors = new List<string>(); Status = DimensionStatus.READY; DimensionTypeId = ElementId.InvalidElementId; }
    }
}
