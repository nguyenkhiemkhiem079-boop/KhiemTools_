...
- Current code branch / source HEAD: `phase18/production-gate` / `9452cab`.
...
After the rollback-failure fix was committed, both Release targets were rebuilt from the clean tree. Both DLLs report product version `2.7.2+9452cab8b9067886a3a13f2d8282034eabf25f92`.
